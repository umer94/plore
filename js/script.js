...
function IFTTTDropDown() {
    function a() {
        return $(".dropdown-button")
    }

    function b() {
        return c().hasClass("show-menu")
    }
    ...
    function d() {
        return $(".dropdown-menu > li")
    }

    function e(a) {
        var b = $(a.target),
            c = b.parents(".dropdown").length > 0;
        if (b.hasClass("dropdown") || c) return !1;
        g()
    }

    function f() {
        c().addClass("show-menu"), $(".caret-down").attr("caret-up"), $(document.body).on("click.menu", e)
    }

    function g() {
        c().removeClass("show-menu"), $(".caret-up").attr("caret-down"), $(document.body).off("click.menu")
    }
...
function InstagramFeed(a, b) {
        ...
        function f(a) {
            return a.user.username == "todayatifttt"
        }

        function g(b) {
            var d = _.map(b, function(a) {
                var b = $("<div />").addClass(c);
                return h(b, a)
            });
            a.html(d)
        }
        ...
        function h(a, b) {
            return $(a).css("background-image", "url(" + b + ")")
        }
        ...
        function k() {
            d().done(function(a) {
                var c = _.chain(a.data).filter(f).map(e).shuffle().value();
                j() ? i(c) : g(c), b.rotate && setTimeout(k, 5e3)
            })
        }
        var b = _.defaults(b, {
                className: "thumbnail",
                url: "https://api.instagram.com/v1/tags/goldengatebridge/media/recent",
                clientId: "",
                rotate: !1
            }),
            c = b.className;
    ...
    function(a) {
        "use strict", a.fn.behavior = function(b) {
            return a(this).find("[data-behavior~='#{value}']")
        }, a.behavior = function(b) {
            return a("[data-behavior~='" + b + "']")
        }
